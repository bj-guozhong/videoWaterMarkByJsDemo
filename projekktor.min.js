...
//1.加入watermark3()方法，该方法用于在全屏显示时加水印效果,watermark3()方法来源src="${ctx}/files/water3.js",正常情况下参数为当前登陆人工号和姓名，如传"clear"则清空在全屏显示的水印，即取消全屏。
//2.为了右键不显示自带的广告，去掉mouseleaveHandler:function()之前的如下代码：
